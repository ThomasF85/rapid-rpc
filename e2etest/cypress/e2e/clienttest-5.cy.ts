describe("client test 1", () => {
  ...
  it("mutation without arguments works with context and middleware", () => {
    cy.get('[data-cy="nav-client5"]').click();
  ...
  it("mutation with one arguments works with context and middleware", () => {
    cy.get('[data-cy="nav-client5"]').click();
  ...
  it("mutation with two arguments works with context and middleware", () => {
    cy.get('[data-cy="nav-client5"]').click();
  ...
  it("mutation with object argument works with context and middleware", () => {
    cy.get('[data-cy="nav-client5"]').click();
